(() => {
  ...
  const he = document.querySelector(".sub-menu-header__block"),
    me = document.querySelector(".repair-body-header__button"),
    fe = document.querySelector(".repair-body-header__repair-mobile");
  me.addEventListener("click", function (e) {
    he.classList.toggle("sub-menu-header__block-active"),
      this.classList.toggle("repair-body-header__button-rotated"),
      fe.classList.toggle("repair-mobile-sub-menu-active");
  });
  const ge = document.querySelector(".sub-menu-header-close");
  window.innerWidth > 880 &&
    ge.addEventListener("click", function (e) {
      he.classList.toggle("sub-menu-header__block-active"),
        fe.classList.toggle("repair-mobile-sub-menu-active");
    });
  const ve = document.querySelector(".icon-device"),
    be = document.getElementById("device"),
    ye = document.querySelector(".list-device");
  be.addEventListener("focus", () => {
    ye.classList.toggle("list-device-active"),
      ve.classList.toggle("icon-device-active");
  });
  const we = document.querySelector("#devicebtn");
  ...
  const Se = document.getElementById("mark"),
    ...
    Ce = document.querySelector(".icon-mark");
  Se.addEventListener("focus", () => {
    Te.classList.toggle("list-mark-active"),
      Ce.classList.toggle("icon-mark-active");
  });
  const Ee = document.querySelector("#markbtn");
  ...
  const xe = document.getElementById("model"),
    ...
    ke = document.querySelector(".icon-model");
  xe.addEventListener("focus", () => {
    Le.classList.toggle("list-model-active"),
      ke.classList.toggle("icon-model-active");
  });
  const Me = document.querySelector("#modelbtn");
  Me.addEventListener("click", function (e) {
    Le.classList.toggle("list-model-active"),
      ke.classList.toggle("icon-model-active");
  }),
    ...
    document.addEventListener("click", function (e) {
      ...
      t != be &&
        t != we &&
        (ye.classList.remove("list-device-active"),
        ve.classList.remove("icon-device-active")),
        t != Se &&
          t != Ee &&
          (Te.classList.remove("list-mark-active"),
          Ce.classList.remove("icon-mark-active")),
        t != xe &&
          t != Me &&
          (Le.classList.remove("list-model-active"),
          ke.classList.remove("icon-model-active")),
        t != Oe &&
